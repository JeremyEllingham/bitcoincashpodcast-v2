...
import hotdogPriceFreeze from "@site/static/img/faqs/hotdogPriceFreeze.png";
import hotdogStart from "@site/static/img/faqs/hotdogStart.png";
...
The joke started organically on the Bitcoin Cash telegram group for discussing BCH price movements. A long period of relative BCH price-stability began comparisons to the famously $1.50 fixed price hotdogs at Costco which have not changed in price (despite inflation) since 1985. You can join the fun [here](https://t.me/bchpricechannel).

<img src={hotdogPriceFreeze} alt="Hotdog price freeze" />

_Fact check: true. [Source](https://www.snopes.com/fact-check/costco-founder-kill-hotdogs/)_

<img src={hotdogStart} alt="Hotdog Start" />

_Original hotdog conversation started like this. [Source](https://t.me/bchpricechannel/67013)_
