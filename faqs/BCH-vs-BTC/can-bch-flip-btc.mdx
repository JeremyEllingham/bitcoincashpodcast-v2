...
No one can predict the exact date, but progress is continuous.

Price charts can be deceptive. BTC's lead is nowhere near as large as it might appear. Bitcoin mining industry developments [benefit both coins equally](/faqs/BCH-vs-BTC/is-low-hashrate-a-problem), as do "cryptocurrency" industry development (eg: improvements in exchanges, news aggregators, cryptocurrency event managers and so on). For more on this, see [here](/faqs/BCH-vs-BTC/if-bch-is-so-great-why-is-the-price-low#how-big-is-btcs-lead).
