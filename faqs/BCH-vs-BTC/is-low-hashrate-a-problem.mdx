...
The BCH community has a very clear, sustainable plan to improve the hash rate: [spread adoption](/faqs/BCH/is-bch-spreading), grow the coin's utility, which will (eventually) increase the price and attract mining hash rate by default. This is not a quick fix, but it is a permanent one.
