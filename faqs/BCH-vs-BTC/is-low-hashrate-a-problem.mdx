...
import profitabilityUrl from "@site/static/img/faqs/profitability.png";

import howManyConfsUrl from "@site/static/img/faqs/howmanyconfs.png";
import howManyConfs1Url from "@site/static/img/faqs/howManyConfs1.png";
import howManyConfs2Url from "@site/static/img/faqs/howManyConfs2.png";

<img src={profitabilityUrl} alt="Demonstration of profitability" />

_A demonstration of the magic of the free market. With no central actor, Bitcoin miners allocate hashrate as the market continually evaluates their relative merits._
...
For numbers on what cost to attack is realistically, see [this 51% attack estimator](https://www.crypto51.app/). As of January 2024 (BCH price roughly $230, BTC price roughly $44 000) the listed cost to attack BCH is around $8 000 / hour.
...
<img src={howManyConfsUrl} alt="How many confs screenshot" />

_Propaganda is only visible to eagle-eyed critical thinkers or those with the requisite background knowledge._

Criticising the low BCH hashrate, while partially valid, is often overblown or misunderstood in a classic case of [extreme propaganda](/faqs/BCH-vs-BTC/why-is-there-so-much-propaganda-in-btc). One thing often mentioned in this "analysis" is [howmanyconfs.com](https://howmanyconfs.com/), a site which purports to demonstrate how relatively quickly BTC transactions are secure in comparison to BCH or other coins. The most important part of the site is not actually listed on the site at all, which is the [extensive clarifying note](https://github.com/lukechilds/howmanyconfs.com/blob/master/README.md#how-are-these-values-calculated) that adds a lot of caveats & explanations to the calculations displayed. This critically relevant information is only available from the tiny asterisk * next to "equivalent" in the title, which is an obvious demonstration of the way true information presented without relevant or visible context can deliberately create a totally false imputation.
...
<img src={howManyConfs1Url} alt="How many confs screenshot" />

<img src={howManyConfs2Url} alt="How many confs screenshot" />
...
The reality is that the BCH economy operates 24/7/365 at [instant speed](/faqs/Tech/what-is-0-conf) completely uninterrupted despite its minority hashrate.
...
For more analysis of BCH security, see [this article by Jessquit](https://read.cash/@Jessquit/debunking-btc-is-more-secure-than-bch-e77527a9).
...
## "Majority Scrypt Hashrate"

One argument often made by [Litecoin](/faqs/Cryptocurrency/what-about-litecoin-ltc) [maximalists](/faqs/Culture/what-is-bitcoin-maximalism) or other coins is that it's preferable to be the "majority hash" of their coin's mining algorithm (Scrypt in the case of LTC) rather than a minority of the hashrate on Bitcoin's SHA256 algorithm. The premise of this is that BCH is at risk of 51% attacks from unfriendly [BTC] miners in a way that their coin is not.

This argument may be convincing to adopters of those coins, who need a reason to justify [why NOT BCH](/faqs/BCH/why-not-bitcoin-cash) & ignore [all the reasons for BCH](/faqs/BCH/why-bitcoin-cash).
