...
See [this example](https://twitter.com/brian_trollz/status/1749240142970143144) of debate over Bitcoin's purpose between [BTC maximalist](/faqs/Culture/what-is-bitcoin-maximalism#btc-toxic-maximalism) advocates Bitcoin Mechanic & Shinobi (aka "@brian_trollz"). Their dispute is over data storage on the BTC chain ala [Ordinals](/faqs/BCH-vs-BTC/does-bch-have-ordinals), but it provides a background for Shinobi to inadvertently directly acknowledge BCH are the ones that followed the [whitepaper](/bitcoin.pdf) & [Satoshi's scaling plan](/faqs/Global-Reserve-Currency/can-BCH-technically-scale-to-global-reserve-currency#scaling-pillar-3-pruned-nodes).
