...
import vladPayingInCreditCards from "@site/static/img/faqs/vladPayingInCreditCards.png";
...
<img src={vladPayingInCreditCards} alt="Even at BTC conferences people don't pay in BTC" />

_Bitcoin podcaster Vlad Costea admits that even at BTC conferences people don't pay in BTC. [Source](https://twitter.com/TheVladCostea/status/1781792231566798983)_
...
- **Read surrounding literature**: Read [Hijacking Bitcoin by Roger Ver](/faqs/Media/what-about-roger-vers-book-hijacking-bitcoin) & The Blocksize War by Jonathan Bier, which are the best available retellings of the "big block" & "small block" version of events in The Blocksize War period. The stories overlap in some areas & disagree in others - so anyone can benefit from reading both & deciding for themselves.
