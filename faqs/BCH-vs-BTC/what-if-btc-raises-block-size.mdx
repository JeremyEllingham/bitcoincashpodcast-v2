...
- A need to coalese on [a new brand](/faqs/BCH/will-bitcoin-cash-rebrand) and [governance structure](/faqs/BCH/how-does-BCH-governance-work).
- Technical changes to facilitate competing as an independent Bitcoin fork e.g. a new address format, modifications to difficulty adjustment algorithm, replay protection implementation etc.
...
BCH has already passed through this entire gauntlet, plus continued powering ahead, and any theoretical new fork has yet to start it. Years of debate plus years of post-fork chaos is time that BCH would continue to forge further ahead uninterrupted. No one in the BTC camp is convinced of raising the limit, and if they change their minds it's far, far easier to change sides and join the existing BCH momentum than start again.
