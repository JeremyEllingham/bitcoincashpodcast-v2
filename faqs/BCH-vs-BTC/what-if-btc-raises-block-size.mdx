...
_Bitcoin Cash already **is** the Bitcoin which raised the blocksize limit when it was necessary. [Original source](https://twitter.com/TheBCHPodcast/status/1531674841417502723)_
...
The BTC community does **not have an agreed governance process**. They believe it would be a centralised point of attack. So not only does no-one in the BTC community want a blocksize increase, there is also no recognised process for advocating or agreeing on one.
