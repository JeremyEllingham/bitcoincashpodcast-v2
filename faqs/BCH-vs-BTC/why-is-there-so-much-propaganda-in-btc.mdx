...
_If you're told the lie enough times, it becomes part of your reality. And if enough people are taught that lie, it bcomes part of the culture._

Since the dawn of time, people (especially powerful interest groups) have used propaganda to create advantageous false beliefs among people who would otherwise be a threat to their position. Bitcoin is a severe [threat to government](/start#episode-5-of-10-government) & [banks](/start#episode-6-of-10-banks), so it is no surprise they [enacted a huge campaign of propaganda](/start#episode-8-of-10-bitcoin-cash) to suppress & delay it, which was (& still is) performed through concerted [censorship](/faqs/BCH-vs-BTC/why-is-there-so-much-censorship-in-btc) of the truth. Note that not everyone involved in the fallout is malicious, most are simply naive or misinformed, but a small group of malicious actors is sufficient to create a self-perpetuating flywheel of false beliefs among a much larger rabble.

A huge array of overlapping lies, half-truths, misunderstandings & misinformation was created as part of the *deliberate* attack on Bitcoin which was recognised by big blockers (now BCH) in [The Blocksize War](/start#episode-8-of-10-bitcoin-cash). It successfully [rebranded Bitcoin](/faqs/BCH/will-bitcoin-cash-rebrand) in the minds of the general public & created a culture on the small-block (now BTC) side which has perpetuated & reinforced this panopoly of false information.

A complete list is nearly impossible, but a good start is the [BCH vs BTC section of the Podcast FAQs](/faqs#bitcoin-cash-bch-vs-bitcoin-btc). Note that this is the largest section of the FAQs, larger even than the [section about Bitcoin Cash itself](/faqs#bitcoin-cash-bch) itself. This should give some indication of the scale of the problem.
...
Disabusing / unplugging deeply entrenched BTC coiners is very difficult because of the large extent to which they have been programmed with a wide variety of interrelated misconceptions. They also have many [valid criticisms](/faqs/BCH/why-not-bitcoin-cash) of Bitcoin Cash, so sorting through, distinguishing & addressing each true or false topic is an arduous & time consuming process. It's very difficult to create the holistic paradigm shift necessary unless the subject is open-minded & motivated to improve their own Bitcoin education (for example, by carefully reading through the Bitcoin Cash Podcast FAQs, which they are often not). This is a real shame, but it is a problem the BCH community has relentlessly persisted in attempting to address, despite [equally relentless vilification](/faqs/BCH-vs-BTC/why-do-btc-coiners-have-such-a-specific-vendetta-against-bch). 
