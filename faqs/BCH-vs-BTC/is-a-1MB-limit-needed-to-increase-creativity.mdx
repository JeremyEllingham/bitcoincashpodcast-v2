...
Note also that anyone who thinks it's the easy way out should simply [try raising the 1MB BTC limit](/faqs/BCH-vs-BTC/what-if-btc-raises-block-size) & discover for themselves whether it's a trivial task or not. There's [plenty of problems with BTC](/faqs/BCH-vs-BTC/whats-wrong-with-bitcoin-btc) to drive their creativity.
