...
There used to be regular hand-wringing wherever Bitcoin Cash is discussed along the lines of "The project is finished, the [Blocksize War](/start#episode-8-of-10-bitcoin-cash) is lost, and everyone should give up and sell all their BCH."
...
- **Improved scaling efforts**: 32MB blocks are already live, 256MB blocks are in testing / preparation. BCH has a responsible but effective scaling plan, and will not be bottle-necked by technical issues as community growth continues and momentum snowballs.
...
- **UTXO DeFi:** Bitcoin Cash is developing a whole different direction of UTXO-based DeFi beginning with on-chain protocols such as [AnyHedge](/faqs/Tech/what-is-anyhedge) and consensus protocol improvements such as [CashTokens](/faqs/Tech/what-is-cashtokens).
- **[SmartBCH](/faqs/SmartBCH/what-is-smart-bch)**: A fully-functional EVM-compatible sidechain. This makes Bitcoin Cash the only coin that is simultaneously a better functioning version of both Bitcoin & Ethereum, the two market leading cryptocurrencies.
...
If any more evidence is required, there is [hundreds of hours of The Bitcoin Cash Podcast](/docs/welcome) documenting a non-stop explosion of innovation in the scene, and you can see the resulting network activity and interest reflected in [the statistics](/stats).
