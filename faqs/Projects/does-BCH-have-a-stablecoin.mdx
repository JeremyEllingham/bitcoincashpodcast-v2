...
- **Moria Stablecoin**: The [Riften Labs](https://twitter.com/RiftenLabs) team behind [Cauldron DEX](https://cauldron.quest/) are working on a stablecoin they've already pre-announced called [Moria Money](https://twitter.com/MoriaMoney). A full release is yet to be seen.
