...
- **Money**: As simple as it is, find projects in the Bitcoin Cash ecosystem and send them some satoshis. If you don't have time or clarity on how to help Bitcoin Cash yourself, outsource! Many ecosystem projects will have donation addresses available publically, and if not, contact them and ask for one!
