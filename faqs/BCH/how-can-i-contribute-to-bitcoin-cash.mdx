...
If the project is too expensive to save the required funding, then get creative about ways to lower costs or find a different idea. Not all ideas are meant to be bootstrapped, and if you aren't already in the venture capital game then Bitcoin Cash is not the place to start.
