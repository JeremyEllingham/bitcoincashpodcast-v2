...
Note that none of these three points are replicated by the Bitcoin (BTC) community, who are far less aware of the need for privacy and fungibility. The BTC community does have its own competing privacy solutions (such as Whirlpool or other coinjoin technologies), which operate with the benefit of BTC's greater network effect & liquidity but without the speed or low fees of BCH.

The BCH strategy also accomodates the following properties:
