...
Note that none of these three points are replicated by the Bitcoin (BTC) community, who are far less aware of the need for privacy and fungibility. The BTC community does have its own similar privacy solutions (such as Whirlpool or other coinjoin technologies)
