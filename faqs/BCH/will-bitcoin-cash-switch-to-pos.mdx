...
- **Anonymous participation**: No permission or registration is needed to become a miner on PoW. A chain can never really die. A PoS miner is essentially an account that has to be approved by sitting already approved miners. Which implies that a PoS chain can really die.
