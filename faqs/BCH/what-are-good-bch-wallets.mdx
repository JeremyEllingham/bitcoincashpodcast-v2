...
| Name | Android? | iOS? | Destkop? | BCH only? | Open source? | Non-custodial? | Notes | Website |
| ---- | ------- | ------------ | -------------- | ----- | ---|
| Selene | Yes | Yes | No | Yes | Yes | Yes | Yes | Payments focussed mobile wallet. Discussed on [Episode 82](/episodes/82). | [selene.cash](https://selene.cash) |
| Cashonize |
| Electron Cash mobile |
| Zapit |
| Paytaca |
| Bitcoin.com |
| Flowee |
