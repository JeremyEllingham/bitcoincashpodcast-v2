...
Over time, less & less BCH wallets & apps will even display confirmations to the user. It will become a behind-the-scenes technical detail that 99% of users are entirely unaware of. This is necessary for the slick UX demanded by end consumers. For instance [Selene Wallet](/).
