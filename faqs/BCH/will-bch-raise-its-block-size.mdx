...
This approach tackles the valid concerns over limit management without blithely removing all limits. Even if implemented, the community could always modify or update the algorithm through the [CHIP process](/faqs/Decentralisation/how-does-BCH-governance-work) if unexpected problems or further learning occurred.
