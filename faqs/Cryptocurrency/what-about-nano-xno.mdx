...
- The lack of DeFi. The XNO community may see this as an advantage ("lack of distractions on p2p cash mission"), but from a BCH perspective the XNO community may struggle to compete with the demand (liquidity, network effects, developer interest) generated by competitors with those features. In the case of BCH that means [CashTokens](/faqs/Tech/what-is-cashtokens) & [SmartBCH](/faqs/SmartBCH/what-is-smart-bch).
