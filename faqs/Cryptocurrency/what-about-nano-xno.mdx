...
_Discussion & debate with Milan, a prominent XNO advocate, about the pros & cons of different coins._
...
- **Instant transactions**: Just as with fees, there is no end-user perceivable difference between Nano and many other "instant" cryptocurrencies, including Bitcoin Cash. Bitcoin Cash has [secure 0-confirmation transactions to $10 000+](/faqs/Tech/what-is-0-conf) which are just as fast as Nano, and any larger transactions are not only rare but generally not conducted with haste so great that it can't afford waiting 10 minutes for a block confirmation (when buying a house, it takes some time to sign the papers).
...
- The lack of DeFi (such as [AnyHedge](/faqs/Tech/what-is-anyhedge) or [CashTokens](/faqs/Tech/what-is-cashtokens)). The XNO community may see this as an advantage ("lack of distractions on p2p cash mission"), but from a BCH perspective the XNO community may struggle to compete with the demand (liquidity, network effects, developer interest) generated by competitors with those features.
