...
People new to the scene often discover that many cryptocurrency communities are very set in their beliefs, to the point of actively or aggressively excluding other coins or points of view even. The phenomenon is so prevalent it even has its own name, ["(toxic) maximalism"](/faqs/Culture/what-is-bitcoin-maximalism). This is because of:
...
Bitcoin Cash is shooting to be the coin [used everyday by the whole world](/faqs/Global-Reserve-Currency/what-do-you-mean-global-reserve-currency), so it does have that mindset.

:::tip

This does NOT mean the BCH community should be unwelcoming, closed to innovations in other coins, hostile or exclusionary (a mistake made by some other communities). Individuals can allocate their own resources among any number of coins as they see fit. The vast majority of BCH adopters see it as natural for users to hold multiple coins if and where it makes sense for them, and for all projects to compete in the free market. However, the overall Bitcoin Cash community attitude will be along the lines of "We are going to make BCH so much better than every other coin, that eventually [everyone in the world](/faqs/Global-Reserve-Currency/what-do-you-mean-global-reserve-currency) will want to trade it and rarely or never need any other cryptocurrencies."
...
See also: [What is Bitcoin maximalism?](/faqs/Culture/what-is-bitcoin-maximalism)
