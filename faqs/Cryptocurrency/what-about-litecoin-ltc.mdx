...
The flagship change of Litecoin from Bitcoin was reducing the block time (from 10 minutes to 2.5 minutes), thus increasing capacity 4x. However, their community also prefers to copy the BTC scaling strategy of never raising the block size, therefore this tiny gain cannot help them scale to be a worldwide payments system.
