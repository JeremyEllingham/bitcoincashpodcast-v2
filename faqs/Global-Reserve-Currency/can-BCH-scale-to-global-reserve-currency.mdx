...
- **Blocksize increases**: The community has implemented measures to ensure BCH blocksizes can adapt to network demand, avoiding roadblocks of a static limit or foolish scaling ahead of necessity. See [What is the maximum Bitcoin Cash blocksize?](/faqs/BCH/what-is-the-maximum-bch-blocksize)
