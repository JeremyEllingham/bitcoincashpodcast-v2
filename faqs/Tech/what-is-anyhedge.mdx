...
import anyHedgeRisks from "@site/static/img/faqs/anyHedgeRisks.png";
...
A good starting point might be this informative Reddit post by AnyHedge developer Jonathan Silverblood. [Original source](https://www.reddit.com/r/btc/comments/133nenu/question_is_bch_bull_as_centralized_as_coinflexs/jib9jj3/).

<img src={anyHedgeRisks} alt="AnyHedge Risks" />

See further discussion in [this thread](https://www.reddit.com/r/btc/comments/14fve35/bchbulls_price_oracles_and_decentralization/).
...
- [BCH Bull Premiums charts](https://www.monsterbitar.se/~jonathan/AnyhedgePremiums/): Find profitable opportunities to speculate or hedge.
