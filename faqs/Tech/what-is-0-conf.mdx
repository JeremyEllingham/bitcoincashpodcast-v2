...
import firstSeenWhitepaper from "@site/static/img/faqs/firstSeenWhitepaper.jpg";
...
<CustomReactPlayer
  url={"https://youtu.be/EP5wCmOrVR4?t=5273"} />
...
<img src={firstSeenWhitepaper} alt="First seen whitepaper" />

_Satoshi mentioned the first seen property in the whitepaper directly. However, the [first version of the Bitcoin code](https://github.com/trottier/original-bitcoin/blob/master/src/main.cpp#L434) did allow replacing transactions, which was updated once it became a DDoS vulnerability._
...
As of 2023, the removal of the first seen policy & introduction of compulsory Replace-By-Fee remains controversial to prominent members of the BTC community such as John Carvalho of Synonym & Sergej Kotliar of the payment focussed Bitrefill team.
