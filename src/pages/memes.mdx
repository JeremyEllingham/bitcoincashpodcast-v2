...
import usebch from "@site/static/img/memes/Use BCH.jpg";
...
import paymeinBitcoin from "@site/static/img/memes/paymeinBitcoin.jpg";
import iwanttohatebcashers from "@site/static/img/memes/i want to hate bcashers.png";
...
<img src={paymeinBitcoin} alt="Meme" />

_Pay me in Bitcoin. Done. Says it all right there._

<img src={dogeChess} alt="Doge chess" />

_Doge plays chess, just like BCH Twitter playing BTC Twitter._

<img src={iwanttohatebcashers} alt="Meme" />

_I don't want to fix broken BTC or fix the problem, I want to hate bcashers. Can't save someone determined not to find a solution like this book burning guy._
...
<img src={usebch} alt="Use BCH" />

_USE BCH. Attention grabber in comment sections._
